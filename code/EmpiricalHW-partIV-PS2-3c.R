...
ggsave(filename = "fig.6.c.1.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.2.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
...
ggsave(filename = "fig.6.c.3.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.4.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.5.pdf", plot = p3, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.6.pdf", plot = p4, path = "output/figs/Part IV/", width = 8, height = 8)
...
ggsave(filename = "fig.6.c.7.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.8.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.9.pdf", plot = p3, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.10.pdf", plot = p4, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.11.pdf", plot = p5, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.c.12.pdf", plot = p6, path = "output/figs/Part IV/", width = 8, height = 8)
