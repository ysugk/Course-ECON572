...
ggsave(filename = "fig.6.a.1.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.2.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
...
ggsave(filename = "fig.6.a.3.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.4.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.5.pdf", plot = p3, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.6.pdf", plot = p4, path = "output/figs/Part IV/", width = 8, height = 8)
...
ggsave(filename = "fig.6.a.7.pdf", plot = p1, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.8.pdf", plot = p2, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.9.pdf", plot = p3, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.10.pdf", plot = p4, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.11.pdf", plot = p5, path = "output/figs/Part IV/", width = 8, height = 8)
ggsave(filename = "fig.6.a.12.pdf", plot = p6, path = "output/figs/Part IV/", width = 8, height = 8)
